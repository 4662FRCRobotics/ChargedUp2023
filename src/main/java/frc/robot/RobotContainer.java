...
import frc.robot.subsystems.ArmTurntable;
...
public class RobotContainer {
  ...
  private final ArmTurntable m_ArmTurntable = new ArmTurntable();
  ...
  public RobotContainer() {
    ...
    m_ArmTurntable.setDefaultCommand(
      Commands.run(
        () -> m_ArmTurntable.moveTurntable(m_operatorController.getLeftX()),
        m_ArmTurntable));
